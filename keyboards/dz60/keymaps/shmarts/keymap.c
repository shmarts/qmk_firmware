...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_60_ansi(
		...
		KC_LCTL, SUPR, KC_LALT, KC_SPC, KC_RALT, SUPR, MENU, KC_RCTL),
	...
	LAYOUT_60_ansi(
		...
		MO(2), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		KC_LCTL, SUPR, KC_LALT, _______, KC_RALT, SUPR, MENU, KC_RCTL),

  LAYOUT_60_ansi(
		_______, _______, _______, KC_9, UC(0x00A3), _______, _______, _______, _______, _______, _______, _______, _______, _______,
